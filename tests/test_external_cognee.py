"""Tests for the cognee adapter (logic via the shared fake client)."""
...
from membench.retrieval.external import cognee_adapter  # noqa: F401  (registration)
...
def test_maps_results_back_to_item_ids() -> None:
    arm = build_arm("cognee", client=LexicalIdSearchClient())
