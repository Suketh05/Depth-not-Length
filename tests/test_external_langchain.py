"""Tests for the langchain_vec adapter (logic via the shared fake client)."""
...
from membench.retrieval.external import langchain_adapter  # noqa: F401  (registration)
...
def test_maps_results_back_to_item_ids() -> None:
    arm = build_arm("langchain_vec", client=LexicalIdSearchClient())
